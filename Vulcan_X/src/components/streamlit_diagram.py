# src/components/streamlit_diagram.py
...
class StreamlitDiagramRenderer:
    ...
    # Removed 'key' parameter from here as components.html doesn't accept it directly
    def render_diagram_auto(self, code, height=600):
        ...
        try:
            ...
            if html_content is not None:
                # No 'key' parameter passed to components.html
